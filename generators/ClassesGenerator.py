...
from UnityPy.typetree.Tpk import get_tpktypetree, TpkUnityNode
from UnityPy.typetree.TypeTreeHelper import clean_name

TPKTYPETREE = get_tpktypetree()
...
def main():
    ...
    fp = os.path.join(ROOT, "UnityPy", "objects", "generated.py")
