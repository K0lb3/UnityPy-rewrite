...
from .math import Matrix4x4f, float4, Matrix3x4f, ColorRGBA, float3, Vector4f, Vector2f, Quaternionf, Vector3f
...
class AssetMetaData(Object):
  ...
  originalDigest: Optional[Union[MdFour, Hash128]] = None
...
class HingeJoint2D(AnchoredJoint2D):
  m_Anchor: Vector2f
  m_AngleLimits: Union[JointAngleLimits2D, JointAngleLimit2D]
  m_ConnectedAnchor: Vector2f
  m_ConnectedRigidBody: PPtr[Rigidbody2D]
  m_Enabled: int
  m_GameObject: PPtr[GameObject]
...
class VisualEffect(Behaviour):
  ...
  m_ResetSeedOnPlay: Union[int, bool]
  m_StartSeed: int
...
class BoxCollider(Collider):
  ...
  m_GameObject: PPtr[GameObject]
  m_IsTrigger: bool
  m_Material: Union[PPtr[PhysicsMaterial], PPtr[PhysicMaterial]]
  m_Size: Vector3f
  m_ExcludeLayers: Optional[BitField] = None
  m_IncludeLayers: Optional[BitField] = None
  m_LayerOverridePriority: Optional[int] = None
...
class CharacterController(Collider):
  ...
  m_LayerOverridePriority: Optional[int] = None
  m_Material: Optional[Union[PPtr[PhysicsMaterial], PPtr[PhysicMaterial]]] = None
  m_ProvidesContacts: Optional[bool] = None
...
class ParticleSystem(Component):
  ...
  looping: bool
  m_GameObject: PPtr[GameObject]
  moveWithTransform: Union[int, bool]
  playOnAwake: bool
  prewarm: bool
  randomSeed: int
...
class BillboardRenderer(Renderer):
  ...
  m_ReceiveShadows: Union[int, bool]
  m_ReflectionProbeUsage: int
  m_SortingOrder: int
...
class AudioImporter(AssetImporter):
  ...
  m_Output: Optional[Union[Output, AudioImporterOutput]] = None
  m_PlatformSettingOverrides: Optional[Union[List[Tuple[str, SampleSettings]], List[Tuple[int, SampleSettings]]]] = None
...
class PluginImporter(AssetImporter):
  ...
  m_PlatformData: Union[List[Tuple[str, PlatformSettingsData]], List[Tuple[Tuple[str, str], PlatformSettingsData]]]
  m_UserData: str
...
class TextureImporter(AssetImporter):
  ...
  m_IgnorePngGamma: Optional[Union[int, bool]] = None
  m_InternalIDToNameTable: Optional[List[Tuple[Tuple[int, int], str]]] = None
  ...
  m_PlatformSettings: Optional[Union[List[TextureImporterPlatformSettings], List[PlatformSettings]]] = None
...
class VideoClipImporter(AssetImporter):
  ...
  m_StartFrame: int
  m_TargetSettings: Union[List[Tuple[str, VideoClipImporterTargetSettings]], List[Tuple[int, VideoClipImporterTargetSettings]]]
  m_UserData: str
...
class Mesh(NamedObject):
  ...
  m_Skin: Optional[Union[List[BoneWeights4], List[BoneInfluence]]] = None
...
class MonoScript(TextAsset):
  ...
  m_Name: str
  m_Namespace: str
  m_PropertiesHash: Union[int, Hash128]
...
class PhysicsManager(GlobalGameManager):
  ...
  m_DefaultMaterial: Union[PPtr[PhysicsMaterial], PPtr[PhysicMaterial]]
  m_Gravity: Vector3f
  m_LayerCollisionMatrix: List[int]
  m_AutoSimulation: Optional[bool] = None
  m_AutoSyncTransforms: Optional[bool] = None
...
class Asset:
  ...
  hash: Optional[Union[MdFour, Hash128]] = None
...
class CachedAssetMetaData:
  ...
  originalDigest: Union[MdFour, Hash128]
  originalName: str
  originalParent: GUID
  pathName: str
...
class ClipMuscleConstant:
  ...
  m_AverageSpeed: Union[float4, float3]
  m_Clip: OffsetPtr
  m_CycleOffset: float
...
class ComputeShaderCB:
  byteSize: int
  name: Union[str, FastPropertyName]
...
class ComputeShaderKernel:
  ...
  name: Optional[Union[str, FastPropertyName]] = None
...
class ComputeShaderResource:
  ...
  generatedName: Optional[Union[str, FastPropertyName]] = None
...
class HumanGoal:
  ...
  m_WeightT: float
  m_X: xform
  m_HintT: Optional[Union[float4, float3]] = None
...
class HumanPose:
  ...
  m_LookAtPosition: Union[float4, float3]
...
class Item:
  ...
  digest: Optional[Union[MdFour, Hash128]] = None
...
@define(kw_only=True, slots=False)
class Limit:
  m_Max: Union[float4, float3]
  m_Min: Union[float4, float3]
...
class NavMeshBuildSettings:
  ...
  manualCellSize: Union[int, bool]
  manualTileSize: Union[int, bool]
  maxJumpAcrossDistance: float
  minRegionArea: float
  tileSize: int
  accuratePlacement: Optional[Union[int, bool]] = None
...
@define(kw_only=True, slots=False)
class OffsetPtr:
  data: Union[Blend1dDataConstant, SelectorTransitionConstant, ValueArray, Clip, ConditionConstant, Blend2dDataConstant, LayerConstant, SkeletonPose, BlendTreeConstant, StateMachineConstant, BlendTreeNodeConstant, HumanLayerConstant, SelectorStateConstant, TransitionConstant, StateConstant, Human, Hand, SkeletonMask, BlendDirectDataConstant, ValueArrayConstant, Skeleton]
...
class ProceduralTextureAssignment:
  ...
  shaderProp: Union[str, FastPropertyName]
...
class ShapeModule:
  ...
  m_Mesh: PPtr[Mesh]
  placementMode: int
  radius: Union[float, MultiModeParameter]
  type: int
  alignToDirection: Optional[bool] = None
  arc: Optional[Union[float, MultiModeParameter]] = None
...
class TilemapRefCountedData:
  m_Data: Union[PPtr[GameObject], PPtr[Sprite], ColorRGBA, PPtr[Object], Matrix4x4f]
  m_RefCount: int
...
class UnityPropertySheet:
  ...
  m_TexEnvs: Union[List[Tuple[str, UnityTexEnv]], List[Tuple[FastPropertyName, UnityTexEnv]]]
...
class VFXEntryExposed:
  m_Name: str
  m_Overridden: bool
  m_Value: Union[Matrix4x4f, AnimationCurve, bool, PPtr[NamedObject], int, Vector4f, float, PPtr[Object], Vector2f, Gradient, Vector3f]
...
class xform:
  q: float4
  s: Union[float4, float3]
  t: Union[float4, float3]
