...
from .math import ColorRGBA, Matrix3x4f, Matrix4x4f, Quaternionf, Vector2f, Vector3f, Vector4f
...
class ParticleSystem(Component):
  ...
  prewarm: bool
  randomSeed: int
  startDelay: Union[float, MinMaxCurve]
...
class GameObject(EditorExtension):
  m_Component: Union[List[Tuple[int, PPtr[Component]]], List[ComponentPair]]
...
class BuildSettings(GlobalGameManager):
  ...
  runtimeClassHashes: Optional[Union[List[Tuple[int, int]], List[Tuple[int, Hash128]]]] = None
...
class TimeManager(GlobalGameManager):
  Fixed_Timestep: Union[float, RationalTime]
...
class HierarchyState(Object):
  ...
  scrollposition_x: float
  scrollposition_y: float
...
class Asset:
  ...
  guidOfPathLocationDependencies: Optional[Union[List[Tuple[str, GUID]], List[Tuple[GUID, str]]]] = None
...
class InitialModule:
  enabled: bool
  gravityModifier: Union[float, MinMaxCurve]
  maxNumParticles: int
...
@define(kw_only=True, slots=False)
class Keyframe:
  inSlope: Union[float, Vector3f, Quaternionf]
  outSlope: Union[float, Vector3f, Quaternionf]
  time: float
  value: Union[float, Vector3f, Quaternionf]
  inWeight: Optional[Union[float, Vector3f, Quaternionf]] = None
  outWeight: Optional[Union[float, Vector3f, Quaternionf]] = None
...
@define(kw_only=True, slots=False)
class OffsetPtr:
  data: Union[StateConstant, HumanLayerConstant, SkeletonMask, ValueArrayConstant, Skeleton, Blend1dDataConstant, TransitionConstant, Blend2dDataConstant, BlendDirectDataConstant, Human, SelectorTransitionConstant, ConditionConstant, StateMachineConstant, Clip, BlendTreeNodeConstant, ValueArray, SkeletonPose, SelectorStateConstant, BlendTreeConstant, Hand, LayerConstant]
...
class TilemapRefCountedData:
  m_Data: Union[PPtr[GameObject], PPtr[Sprite], PPtr[Object], Matrix4x4f, ColorRGBA]
  m_RefCount: int
...
class UnityPropertySheet:
  m_Colors: Union[List[Tuple[str, ColorRGBA]], List[Tuple[FastPropertyName, ColorRGBA]]]
...
class VFXEntryExposed:
  m_Name: str
  m_Overridden: bool
  m_Value: Union[PPtr[NamedObject], Vector3f, bool, int, Vector2f, Gradient, PPtr[Object], Matrix4x4f, float, AnimationCurve, Vector4f]
